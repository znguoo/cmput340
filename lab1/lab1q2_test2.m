close all;
%test case with my own matrix
%based on the result: y=[3;9;19] x=[31,28,19]
%doubled checked this is correct
A=[1 -1 0; -1 2 -1; 0 -1 2];
b=[3;6;10];
% Factorization
[L, U] = myLU(A);
...
function x = backSubst(U,y,k)
    ...
    if k > 1 % Recursion step
        ...
        %other pos are zeros or 1 for thediagonal, so all set to 0
